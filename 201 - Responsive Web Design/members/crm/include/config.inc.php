...
$config_db_user = 'root';
$config_db_password = 'chairmanhbearman';
$config_db_db = 'spacelab_member';

// Site info

// The title to display in the title bar
$config_site_title = 'SpaceLab CRM';

// The name of the organization to insert into templates
$config_org_name = 'SpaceLab CRM';

// The From: address to use when sending email to members
$config_email_from = 'jay@lunargiantstudios.com';

// The email address to notify when a user is created
$config_email_to = 'jay@lunargiantstudios.com';
